    ...
    const benefits = [
        {
            ...
            description: "Take care of your body and mind, get fit, relax and have fun with our wellness activities."
        },
        {
            title: "Dedicated Team",
            description: "Join a family-like team, work together towards success and enjoy a friendly work environment."
        },
        {
            title: "Health Insurance",
            description: "Stay healthy and worry-free with our comprehensive health coverage."
        },
        {
            title: "Corporate Education",
            description: "Boost your skills, stay up-to-date with the latest trends and get promoted!"
        }
    ]
        ...
        <div className="relative min-h-screen bg-[#111111] text-white">
            ...
            <div className="relative pt-32 px-6">
                ...
                <div className="min-h-screen bg-[#111111] text-white p-8 font-mono">
                    ...
                    >
                        why choose <span className="text-orange-500">Auxxweb</span>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    {/* Corners */}
                                    <Corner /> {/* Top Left */}
                                    <span className="absolute top-0 right-0 w-4 h-4 text-gray-600">+</span> {/* Top Right */}
                                    <span className="absolute bottom-0 left-0 w-4 h-4 text-gray-600">+</span> {/* Bottom Left */}
                                    <span className="absolute bottom-0 right-0 w-4 h-4 text-gray-600">+</span> {/* Bottom Right */}
