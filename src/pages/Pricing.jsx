    ...
    <div className="min-h-screen bg-[#111111] p-8">
      ...
      >
        {plans.map((plan) => (
          ...
          >
            {/* Background Glow */}
            <div className={`absolute inset-0 bg-gradient-to-br ${plan.color} blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
            
            {/* Card */}
            <div className="relative bg-[#111111] rounded-3xl p-8 border border-gray-800 backdrop-blur-xl h-full flex flex-col">
              <div className="mb-8">
                <h3 className={`text-2xl text-center font-bold mb-2 ${plan.textColor}`}>
                  {plan.name}
                </h3>
              ...
              <div className="mb-8 pl-20 text-center ">
                <div className="flex text-center  items-baseline">
                  ...
                  {plan.price !== "Contact Us" && (
                    <span className="text-gray-400 text-center  ml-2">/month</span>
                  )}
                </div>
                {plan.price === "Contact Us" && (
                  <span className="text-3xl text-center  text-white">Contact Us</span>
                )}
              </div>
              ...
              <div className="space-y-4 mt-auto">
                {plan.features.map((feature, index) => (
                  ...
                  >
                    <div className={`mt-1 w-5 h-5 rounded-full flex items-center justify-center ${plan.textColor} bg-current/10`}>
